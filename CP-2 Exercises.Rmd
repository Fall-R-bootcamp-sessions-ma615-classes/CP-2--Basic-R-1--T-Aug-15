...
Your function should report in the following format:
...
riverReport <- function(miles) {
  ...
  ifelse(miles == rg, print(paste("A river", miles, "miles long is exactly as long as", rgName)),)
  ifelse(miles < fr, print(paste("A river", miles, "miles long is exactly as long as", frName)),)
  ifelse(miles > rg, print(paste("A river", miles, "miles long is exactly as long as", frName)),)
  ifelse(miles == fr, print(paste("A river", miles, "miles long is exactly as long as", frName)),)
  ifelse(miles == fr, print(paste("A river", miles, "miles long is exactly as long as", frName)),)
  ifelse(miles == fr, print(paste("A river", miles, "miles long is exactly as long as", frName)),)
  ifelse(miles == fr, print(paste("A river", miles, "miles long is exactly as long as", frName)),)
